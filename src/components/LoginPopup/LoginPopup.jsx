  ...
  const LoginPopup = ({setShowLogin}) => {
      ...
      const {url,setToken,setUser,setUserProfileDetails} = useContext(StoreContext);
          ...
          try {
            ...
            if (response.data.success) {
              if (currentstate === 'Login') {
                ...
                console.log("User Profile Details:", response.data.user);
                ...
                console.log("Adeeeeeee user ID ID:", response.data.user.id);
